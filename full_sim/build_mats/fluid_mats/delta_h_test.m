function del_h = delta_h_test( rf, rb , dr )
...
if r1 <= 1
    ...
    del_h = 0.4166666667d-1*r4+(-0.1388888889+0.3472222222d-1*a8).*r3+ ...
...
elseif r1 > 1 & r1 <= 2
    ...
    del_h = -0.6250000000d-1*r4+(.4861111111-0.1736111111d-1*a9).*r3 + ...
...
elseif r1 > 2 & r1 <= 3
    ...
    del_h = 0.2083333333d-1*r4+(0.3472222222d-2.*a7-.2638888889).*r3+ ...
